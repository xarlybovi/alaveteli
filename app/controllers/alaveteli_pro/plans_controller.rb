...
class AlaveteliPro::PlansController < AlaveteliPro::BaseController
  ...
  def authenticate
    post_redirect_params = {
      web: _('To activate your {{pro_site_name}} account',
             pro_site_name: AlaveteliConfiguration.pro_site_name),
      email: _('Then you can activate your {{pro_site_name}} account',
               pro_site_name: AlaveteliConfiguration.pro_site_name),
      email_subject: _('To activate your {{pro_site_name}} account',
                       pro_site_name: AlaveteliConfiguration.pro_site_name) }
